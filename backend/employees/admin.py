    ...
    def action_set(self, obj):
        ...
        for empInOrg in employeeInOrganizations:
            ...
            if obj.company == "AV":
                ...
                tag_string += f'<br /><a target="_blank" style="margin-bottom: 1rem;" href="/api/documents/gph_contract_avangard/{empInOrg.id}">Сформировать договор ГПХ Авангард</a>'
            elif obj.company == "MI":
                ...
                tag_string += f'<br /><a target="_blank" style="margin-bottom: 1rem;" href="/api/documents/gph_contract_mikado/{empInOrg.id}">Сформировать договор ГПХ Микадо</a>'
            elif obj.company == "MP":
                ...
                tag_string += f'<br /><a target="_blank" style="margin-bottom: 1rem;" href="/api/documents/gph_contract_mercury/{empInOrg.id}">Сформировать договор ГПХ Меркурий Плюс</a>'
