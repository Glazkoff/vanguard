# Generated by Django 3.2.3 on 2021-06-10 19:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('INN', models.CharField(max_length=12, validators=[django.core.validators.MinLengthValidator(limit_value=12, message='ИНН не может состоят из менее чем 12 цифр'), django.core.validators.RegexValidator(re.compile('^\\d+(?:\\d+)*\\Z'), code='invalid', message='ИНН должен содержать только цифры')], verbose_name='ИНН')),
                ('SNILS', models.CharField(max_length=11, validators=[django.core.validators.MinLengthValidator(limit_value=11, message='СНИЛС не может состоят из менее чем 11 цифр'), django.core.validators.RegexValidator(re.compile('^\\d+(?:\\d+)*\\Z'), code='invalid', message='СНИЛС должен содержать только цифры')], verbose_name='СНИЛС')),
                ...
                ('dateOfNotificationUFMSadmission', models.DateField(verbose_name='Дата уведомления УФМС при приёме')),
                ('dateOfNotificationUFMSdischarge', models.DateField(verbose_name='Дата уведомления УФМС при увольнении')),
                ('bankDetails', models.TextField(verbose_name='Банковские реквизиты')),
                ('endDateOfRVP', models.DateField(verbose_name='Дата окончания РВП')),
                ('endDateOfResidencePermit', models.DateField(verbose_name='Дата окончания вида на жительство')),
